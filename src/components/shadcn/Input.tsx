  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:aria-invalid:ring-red-500/20 focus:aria-invalid:ring-red-500/40 focus:aria-invalid:border-red-500",
