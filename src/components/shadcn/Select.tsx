  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={
        ...
        bg-transparent px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground
        focus-visible:ring-2 focus-visible:ring-blue-500/20 focus-visible:border-blue-500
        focus:aria-invalid:ring-red-500/20 focus:aria-invalid:border-red-500
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={
        ...
        rounded-md px-2 py-2 text-sm text-right
